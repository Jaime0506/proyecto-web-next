...
export const renderCell = (user: IUser, columnKey: string, openModal: (key: KeyOpenModal, id: string) => void, id: string) => {
    ...
    if (columnKey === "actions") return <Actions  openModal={openModal} id={id} />
